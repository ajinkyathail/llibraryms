                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                ?>
                                    ...
                                    <br >
                                    <form class="form-horizontal row-fluid" action="editbook.php?id=<?php echo $bookid ?>" method="post">
                                        <div class="form-groupp">
                                            <b>
                                            <label class="control-label" for="Title">Book Title:</label></b>
                                            <div class="col-md-12">
                                                <input type="text" id="Title" name="Title" value= "<?php echo $name?>" class="form-control form-control-line" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-groupp">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" id="Publisher" name="Publisher" value= "<?php echo $publisher?>" class="form-control form-control-line" required>
                                            </div>
                                        </div>

                                        <div class="form-groupp">
                                            <b>
                                            <label class="col-md-12" for="Year">Year:</label></b>
                                            <div class="col-md-12">
                                                <input type="text" id="Year" name="Year" value= "<?php echo $year?>" class="form-control form-control-line" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-groupp">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" id="Availability" name="Availability" value= "<?php echo $avail?>" class="form-control form-control-line" required>
                                            </div>
                                        </div>
                                            <br>
                                        <div class="form-groupp">
